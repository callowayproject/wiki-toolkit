...
AI skills that implement and maintain an [LLM Wiki](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f) —
a Raw/Wiki/Schema knowledge base kept current by routing every mutation through a reviewed PR.
...
each wrapping a handful of `wiki-toolkit` CLI commands plus the judgment a CLI alone can't supply:
...
The skills above are the intended day-to-day interface; the `wiki-toolkit` CLI is what they call.
Useful directly for scripting or debugging one step in isolation:
