...
This project and everyone participating is governed by the [Wiki Toolkit Code of Conduct](../CODE_OF_CONDUCT.md).
...
This section guides you through submitting an enhancement suggestion for Wiki Toolkit, including entirely new features and minor improvements to existing functionality. Following these guidelines will help maintainers and the community understand your suggestions and find related suggestions.
...
```console
$ git clone https://github.com/callowayproject/wiki-toolkit.git
...
[documentation]: https://callowayproject.github.io/wiki-toolkit/
[new_issue]: https://github.com/callowayproject/wiki-toolkit/issues/new
[issues]: https://github.com/callowayproject/wiki-toolkit/issues
